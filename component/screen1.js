    ...
    return (
        <view style={styles.container}>
            ...
            <View style={styles.styleImg}>
                <Image source={ route.params?.img||require("../assets/img/vs_blue.png")} style={{width: 301, height: 321}} resizeMode="contain"/> 
            ...
            <View style={styles.style1}>
                ...
                <View style={styles.styleImgStar}>
                    <Image source={require('../assets/img/star.png')} style={[{ height: '25px', width: '23px' }, styles.starImg]} ></Image>
                    <Image source={require('../assets/img/star.png')} style={[{ height: '25px', width: '23px' }, styles.starImg]} ></Image>
                    <Image source={require('../assets/img/star.png')} style={[{ height: '25px', width: '23px' }, styles.starImg]} ></Image>
                    <Image source={require('../assets/img/star.png')} style={[{ height: '25px', width: '23px' }, styles.starImg]} ></Image>
                    <Image source={require('../assets/img/star.png')} style={[{ height: '25px', width: '23px' }, styles.starImg]} ></Image>
            ...
            <View style={styles.style2}>
                ...
                <Image source={require('../assets/img/Group 1.png')} style={{ height: '20px', width: '20px', marginHorizontal: 10 }} ></Image>
            </View>
